"""Pruebas para 18-frontier-safety-frameworks-rsp-pf-fsf."""
...
class TestF18_Frontier_Safety_F(unittest.TestCase):
    """Tests para 18-frontier-safety-frameworks-rsp-pf-fsf."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['rsp_compliance_check', 'compute_threshold_gate', 'safety_case_report']:
