"""Pruebas para 21-fairness-criteria-group-individual-counterfactual."""
...
class TestF21_Fairness_Criteria(unittest.TestCase):
    """Tests para 21-fairness-criteria-group-individual-counterfactual."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['demographic_parity', 'equalized_odds', 'counterfactual_fairness']:
