"""Pruebas para 09-alignment-faking."""
...
class TestF09_Alignment_Faking(unittest.TestCase):
    """Tests para 09-alignment-faking."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['detect_alignment_faking', 'measure_faking_rate']:
