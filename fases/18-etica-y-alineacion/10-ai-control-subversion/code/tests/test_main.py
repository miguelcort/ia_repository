"""Pruebas para 10-ai-control-subversion."""
...
class TestF10_Ai_Control_Subver(unittest.TestCase):
    """Tests para 10-ai-control-subversion."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['ai_control_protocol', 'safety_case_eval']:
