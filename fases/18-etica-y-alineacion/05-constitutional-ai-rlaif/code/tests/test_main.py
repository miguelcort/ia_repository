"""Pruebas para 05-constitutional-ai-rlaif."""
...
class TestF05_Constitutional_Ai(unittest.TestCase):
    """Tests para 05-constitutional-ai-rlaif."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['constitutional_critique', 'constitutional_revise', 'rlaif_pair']:
