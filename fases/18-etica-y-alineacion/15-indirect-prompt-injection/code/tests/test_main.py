"""Pruebas para 15-indirect-prompt-injection."""
...
class TestF15_Indirect_Prompt_I(unittest.TestCase):
    """Tests para 15-indirect-prompt-injection."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['indirect_injection_attack', 'tag_untag_defense', 'detect_injection']:
