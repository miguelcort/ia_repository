"""Pruebas para 07-sleeper-agents-persistent-deception."""
...
class TestF07_Sleeper_Agents_Pe(unittest.TestCase):
    """Tests para 07-sleeper-agents-persistent-deception."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['sleeper_trigger', 'detect_sleeper']:
