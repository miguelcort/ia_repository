"""Pruebas para 11-scalable-oversight-weak-to-strong."""
...
class TestF11_Scalable_Oversigh(unittest.TestCase):
    """Tests para 11-scalable-oversight-weak-to-strong."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['weak_to_strong_loss', 'debate_protocol']:
