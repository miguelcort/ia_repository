"""Pruebas para 26-model-system-dataset-cards."""
...
class TestF26_Model_System_Data(unittest.TestCase):
    """Tests para 26-model-system-dataset-cards."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['model_card', 'dataset_card', 'system_card']:
