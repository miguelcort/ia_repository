"""Pruebas para 27-data-provenance-training-governance."""
...
class TestF27_Data_Provenance_T(unittest.TestCase):
    """Tests para 27-data-provenance-training-governance."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['data_provenance_record', 'copyright_filter', 'opt_out_check', 'training_governance_policy']:
