"""Pruebas para 04-sycophancy-rlhf-amplification."""
...
class TestF04_Sycophancy_Rlhf_A(unittest.TestCase):
    """Tests para 04-sycophancy-rlhf-amplification."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['sycophancy_rate', 'sycophancy_amplification']:
