"""Pruebas para 08-in-context-scheming-frontier-models."""
...
class TestF08_In_Context_Schemi(unittest.TestCase):
    """Tests para 08-in-context-scheming-frontier-models."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['detect_sandbagging', 'detect_self_preservation', 'detect_scheming_chain_of_thought']:
