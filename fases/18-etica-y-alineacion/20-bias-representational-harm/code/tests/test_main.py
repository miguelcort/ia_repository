"""Pruebas para 20-bias-representational-harm."""
...
class TestF20_Bias_Representati(unittest.TestCase):
    """Tests para 20-bias-representational-harm."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['bbq_eval', 'stereotype_score']:
