"""Pruebas para 30-dual-use-risk-cyber-bio-chem-nuclear."""
...
class TestF30_Dual_Use_Risk_Cyb(unittest.TestCase):
    """Tests para 30-dual-use-risk-cyber-bio-chem-nuclear."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['dual_use_risk_score', 'threat_model', 'uplift_benchmark']:
