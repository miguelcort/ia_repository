"""Pruebas para 25-echoleak-cves-for-ai."""
...
class TestF25_Echoleak_Cves_For(unittest.TestCase):
    """Tests para 25-echoleak-cves-for-ai."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['echo_leak_check', 'cve_database_lookup', 'vulnerability_classify']:
