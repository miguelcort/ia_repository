"""Pruebas para 16-red-team-tooling-garak-llamaguard-pyrit."""
...
class TestF16_Red_Team_Tooling_(unittest.TestCase):
    """Tests para 16-red-team-tooling-garak-llamaguard-pyrit."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['run_garak_scan', 'pyrit_conversation', 'llamaguard_check']:
