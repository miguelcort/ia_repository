"""Pruebas para 14-ascii-art-visual-jailbreaks."""
...
class TestF14_Ascii_Art_Visual_(unittest.TestCase):
    """Tests para 14-ascii-art-visual-jailbreaks."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['ascii_art_jailbreak', 'visual_prompt_injection', 'ocr_defense']:
