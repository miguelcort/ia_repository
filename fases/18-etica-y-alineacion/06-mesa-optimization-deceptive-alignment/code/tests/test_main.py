"""Pruebas para 06-mesa-optimization-deceptive-alignment."""
...
class TestF06_Mesa_Optimization(unittest.TestCase):
    """Tests para 06-mesa-optimization-deceptive-alignment."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['mesa_alignment_score', 'deceptive_alignment_detector']:
