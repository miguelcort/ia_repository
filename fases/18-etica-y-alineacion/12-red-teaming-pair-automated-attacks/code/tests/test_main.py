"""Pruebas para 12-red-teaming-pair-automated-attacks."""
...
class TestF12_Red_Teaming_Pair_(unittest.TestCase):
    """Tests para 12-red-teaming-pair-automated-attacks."""
