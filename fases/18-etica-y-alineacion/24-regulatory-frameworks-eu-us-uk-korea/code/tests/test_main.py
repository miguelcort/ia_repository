"""Pruebas para 24-regulatory-frameworks-eu-us-uk-korea."""
...
class TestF24_Regulatory_Framew(unittest.TestCase):
    """Tests para 24-regulatory-frameworks-eu-us-uk-korea."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['eu_ai_act_risk_level', 'compliance_checklist', 'audit_trail']:
