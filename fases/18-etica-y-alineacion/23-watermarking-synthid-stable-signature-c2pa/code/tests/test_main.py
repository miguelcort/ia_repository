"""Pruebas para 23-watermarking-synthid-stable-signature-c2pa."""
...
class TestF23_Watermarking_Synt(unittest.TestCase):
    """Tests para 23-watermarking-synthid-stable-signature-c2pa."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['token_watermark', 'detect_watermark', 'c2pa_provenance']:
