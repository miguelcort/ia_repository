"""Pruebas para 13-many-shot-jailbreaking."""
...
class TestF13_Many_Shot_Jailbre(unittest.TestCase):
    """Tests para 13-many-shot-jailbreaking."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['many_shot_attack', 'measure_attack_success']:
