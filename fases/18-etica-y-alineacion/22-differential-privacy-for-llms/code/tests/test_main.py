"""Pruebas para 22-differential-privacy-for-llms."""
...
class TestF22_Differential_Priv(unittest.TestCase):
    """Tests para 22-differential-privacy-for-llms."""
    ...
    def test_funciones_definidas(self):
        ...
        for f in ['clip_gradients', 'add_noise', 'dp_sgd_step']:
